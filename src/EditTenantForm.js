...
function EditTenantForm({ onUpdateTenant }) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <label> Ref:
                <input type="text" name="ref" placeholder="e.g. 123John" onChange={handleChange} value={tenant.ref} />
            </label>
            <label> Property:
                <input type="text" name="property" placeholder="e.g. 123 StreetName Street Suburb NSW 1111" onChange={handleChange} value={tenant.property} />
            </label>
            <label> First Name:
                <input type="text" name="fname" placeholder="e.g. John" onChange={handleChange} value={tenant.fname} />
            </label>
            <label> Last Name:
                <input type="text" name="lname" placeholder="e.g. Doe" onChange={handleChange} value={tenant.lname} />
            </label>
            <label> Mobile:
                <input type="tel" name="mobile" pattern="04[0-9]{8}" placeholder="e.g. 0400111000" onChange={handleChange} value={tenant.mobile} />
            </label>
            <label> Email:
                <input type="email" name="email" placeholder="e.g. hi@example.com" onChange={handleChange} value={tenant.email} />
            </label>
